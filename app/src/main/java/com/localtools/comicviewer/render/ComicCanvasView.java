package com.localtools.comicviewer.render;
...
import com.localtools.comicviewer.util.PageLayoutEngine;
import com.localtools.comicviewer.util.Ui;
import com.localtools.comicviewer.util.ZoomGestureGate;
...
public final class ComicCanvasView extends View {
    ...
    private void drawContinuous(Canvas canvas) {
        ...
        float prefetch = getHeight() * 0.55f;
